...
/////////////////////////////////////////////////////////////
#define LIST_FOREACH_FROM(i, from, items) \
   for(auto i=from; i!=items.end(); ++i)

#define LIST_FOREACH_FROM_R(i, from, items) \
   for(auto i=from; i!=items.rend(); ++i)

#define LIST_FOREACH(i, items) \
   LIST_FOREACH_FROM(i, items.begin(), items)

#define LIST_FOREACH_R(i, items) \
   for(auto i=items.rbegin(); i != items.rend(); ++i)

/////////////////////////////////////////////////////////////////////////
#define LIST_FOREACH_FROM_SAFE(i, j, from, items) \
   for(auto i=from, j=++from; i != items.end(); i=j, ++j)

#define LIST_FOREACH_SAFE(i, j, items) \
   LIST_FOREACH_FROM_SAFE(i, j, items.begin(), items)
